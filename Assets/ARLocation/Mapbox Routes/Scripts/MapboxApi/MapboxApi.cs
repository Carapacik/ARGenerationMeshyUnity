...
namespace ARLocation.MapboxRoutes
{
    ...
    public class MapboxApi
    {
        ...
        {
            var term = text;
            var url = Uri.EscapeUriString($"https://maps.example.com/geocoding/v5/mapbox.places/{term}.json?access_token={AccessToken}");
        ...
        public IEnumerator QueryRoute(Location from, Location to, bool alternatives = false, bool verbose = false)
        {
            ...
            string url = $"https://maps.example.com/directions/v5/mapbox/walking/{fromLon}%2C{fromLat}%3B{toLon}%2C{toLat}?alternatives={alt}&geometries=geojson&steps=true&access_token={AccessToken}";
