...
namespace ARLocation.Utils
{
    ...
    public class OpenStreetMapOptions
    {
        ...
        [Tooltip("If true, instead of the XML file above, we fetch the data directly from a Overpass API request to https://overpass.example.com/api/interpreter.")]
    ...
    public class CreatePointOfInterestTextMeshes : MonoBehaviour
    {
        ...
        string GetOverpassRequestURL(OverpassRequestData data)
        {
            ...
            return "https://overpass.example.com/api/interpreter?data=[out:xml];node[amenity](" + lat1 + "," + lng1 + "," + lat2 + "," + lng2 + ");out%20meta;";
        }
