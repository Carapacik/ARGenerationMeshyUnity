...
namespace Mapbox.MapboxSdkCs.UnitTest
{
	...
	internal class FileSourceTest
	{
		...
		private const string _url = "https://maps.example.com/geocoding/v5/mapbox.places/helsinki.json";
...
#endif
		{
			var request = _fs.Request(
				...
				"https://tiles.example.com/v4/mapbox.mapbox-terrain-v2,mapbox.mapbox-streets-v7/10/545/361.vector.pbf",
				(Response res) =>
				{
